  ...
  return (
    <main className="space-y-6">
      <Prose>
        ...
        <p>
          ❄️🍷🍀⚽🍜🍒🧸🍓🍞🦒🐶／🍣🐼🦕🛣️🐙・⛩️🏀🐣🐸／（⚫🔻⚫）🌈🐨⚾／💎🐺🫶🏻🍫✨⛵🪼🐑💐🌱🎀・🌻／✒️🦀📣🪭🩰⚔️🏓🎠🎺🧁
          I create D&D characters based on Hinatazaka46 members
        </p>
      ...
      <div className="grid md:grid-cols-3 gap-4 mt-6">
        ...
        >
          ...
          <span>
            Posts
            {/* <span className="block text-sm text-muted-foreground">All posts from your WordPress</span> */}
          </span>
        </Link>
        {/* <Link
          className="border h-48 bg-accent/50 rounded-lg p-4 flex flex-col justify-between hover:scale-[1.02] transition-all"
        ...
        >
          <File size={32} />
          <span>
            Pages <span className="block text-sm text-muted-foreground">Custom pages from your WordPress</span>
          </span>
        </Link>
        <Link
          className="border h-48 bg-accent/50 rounded-lg p-4 flex flex-col justify-between hover:scale-[1.02] transition-all"
        ...
        >
          <User size={32} />
          <span>
            Authors <span className="block text-sm text-muted-foreground">List of the authors from your WordPress</span>
          </span>
        </Link> */}
        <Link
          className="border h-48 bg-accent/50 rounded-lg p-4 flex flex-col justify-between hover:scale-[1.02] transition-all"
        ...
        >
          ...
          <span>
            Categories
            {/* <span className="block text-sm text-muted-foreground">Categories from your WordPress</span> */}
          </span>
        </Link>
        {/* <a
          className="border h-48 bg-accent/50 rounded-lg p-4 flex flex-col justify-between hover:scale-[1.02] transition-all"
        ...
        >
          <Folder size={32} />
          <span>
            Documentation <span className="block text-sm text-muted-foreground">How to use `next-wp`</span>
          </span>
        </a> */}
      </div>
    </main>
